...
export type AssetType = 'us-equity' | 'pk-equity' | 'crypto' | 'bond' | 'fd' | 'cash' | 'metals' | 'commodities' | 'kse100' | 'spx500'
...
export const ASSET_TYPE_COLORS: Record<AssetType, string> = {
  ...
  'spx500': '#a855f7', // purple (lighter than bond)
}

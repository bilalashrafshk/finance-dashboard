    ...
    return (
        <>
            <button
                ...
                className="relative h-9 w-full justify-start rounded-lg bg-muted border border-border text-sm font-normal text-muted-foreground shadow-sm hover:bg-accent transition-colors px-4 flex items-center gap-2 sm:pr-12 md:w-32 lg:w-40 xl:w-48 2xl:w-64"
            >
                <Search className="h-4 w-4" />
                <span className="hidden xl:inline-flex">Search assets...</span>
                <span className="inline-flex xl:hidden">Search...</span>
                <kbd className="pointer-events-none absolute right-[0.3rem] top-[0.3rem] hidden h-5 select-none items-center gap-1 rounded border border-border bg-background px-1.5 font-mono text-[10px] font-medium opacity-100 sm:flex text-muted-foreground">
            ...
            >
                ...
                />
                <CommandList className="bg-popover border-t border-border min-h-[300px]">
                    {loading ? (
                                            ...
                                            <div className="flex items-center justify-between w-full">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="flex flex-col">
                                                        ...
                                                        <span className="text-muted-foreground text-xs truncate max-w-[180px]">{item.name}</span>
                                                    </div>
                                                </div>

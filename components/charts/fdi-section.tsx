...
const SERIES_KEY = 'TS_GP_FI_SUMFIPK_M.FI00030'
...
export function FDISection() {
  ...
  const chartOptions = useMemo(() => ({
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Net Foreign Direct Investment in Pakistan',
        font: {
          size: 16,
          ...
          {latestValue !== null && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 border rounded-lg">
                <div className="text-sm text-muted-foreground">Current Net FDI</div>

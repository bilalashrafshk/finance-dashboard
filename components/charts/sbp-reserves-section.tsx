...
const SERIES_KEY = 'TS_GP_BOP_BPM6SUM_M.P00730'

export function SBPReservesSection() {
  ...
  const chartOptions = useMemo(() => ({
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'SBP Gross Foreign Exchange Reserves',
        font: {
          size: 16,
          ...
          {latestValue !== null && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 border rounded-lg">
                <div className="text-sm text-muted-foreground">Current Reserves</div>
                <div className="text-2xl font-bold mt-1 flex items-center gap-2">
                  <TrendingUp className="h-5 w-5" />
                  ${(latestValue / 1000).toFixed(2)}B
                </div>
              ...
              {change !== null && (
                <div className="p-4 border rounded-lg">
                  ...
                  <div className={`text-2xl font-bold mt-1 flex items-center gap-2 ${
                    ...
                    {change > 0 ? '+' : ''}${(change / 1000).toFixed(2)}B
                  </div>
                  {changePercent !== null && (
                    <div className="text-xs text-muted-foreground mt-1">

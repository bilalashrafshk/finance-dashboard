/**
 * Test script to check output format of additional SBP EasyData API series
 */
...
const SERIES_TO_TEST = [
  ...
  },
  {
    ...
    startDate: '2024-01-01', // Weekly data, use recent date
  },
]
...
async function runTests() {
  console.log('Testing Additional SBP EasyData API Series Output Formats\n')

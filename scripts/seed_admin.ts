...
async function seedAdmin() {
    ...
    try {
        ...
        const role = 'admin';
        // Use a default password or leave existing if updating
        // For safety, let's not reset password if user exists, just update role.
        // If user doesn't exist, we create with a temp password.

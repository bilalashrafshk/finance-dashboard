/**
 * Migration script to create SBP Economic Data tables (CPI, GDP, Exchange Rate, etc.)
 * Run with: node scripts/migrate-economic-data-tables.js
 */
...
async function runMigration() {
  ...
  try {
    console.log('🔄 Running SBP Economic Data tables migration...')
